...
extension Dish: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.dishName) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.estimatedAvgCalories) }()
      case 3: try { try decoder.decodeRepeatedStringField(value: &self.ingredients) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.totalAvgWeight) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.dishName.isEmpty {
      try visitor.visitSingularStringField(value: self.dishName, fieldNumber: 1)
    }
    if self.estimatedAvgCalories != 0 {
      try visitor.visitSingularInt32Field(value: self.estimatedAvgCalories, fieldNumber: 2)
    }
    if !self.ingredients.isEmpty {
      try visitor.visitRepeatedStringField(value: self.ingredients, fieldNumber: 3)
    }
    if self.totalAvgWeight != 0 {
      try visitor.visitSingularInt32Field(value: self.totalAvgWeight, fieldNumber: 4)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension TodayFood: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.dishesToday) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    if !self.dishesToday.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.dishesToday, fieldNumber: 1)
    }
